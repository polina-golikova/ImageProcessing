...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gausKirn = new QLineEdit(centralwidget);
        gausKirn->setObjectName("gausKirn");
        gausKirn->setGeometry(QRect(480, 170, 41, 21));
        gausKirn->setFont(font1);
