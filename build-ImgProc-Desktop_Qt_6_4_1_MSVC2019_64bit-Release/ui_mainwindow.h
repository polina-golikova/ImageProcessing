...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_8->setGeometry(QRect(620, 200, 161, 21));
        label_8->setFont(font1);
        sobKern = new QLineEdit(centralwidget);
        sobKern->setObjectName("sobKern");
        sobKern->setGeometry(QRect(570, 200, 41, 21));
